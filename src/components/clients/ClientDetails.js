...
class ClientDetails extends Component {
  ...
  onDeleteClick = () => {
      ...
      firestore.delete({collection: 'client', doc: client.id}).then(history.push('/'));
  };
           ...
           <div className="row">
            <div className="col-md-6">
                <Link to="/" className="btn btn-link">
                    <i className="fas fa-arrow-circle-left"/> Back to Dasgboard
                </Link>
            </div>
            <div className="col-md-6">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col-sm-6">
                        <h3 className="pull-right">
                            Balance: <span className={classnames({'text-danger': client.balance > 0, 'text-succes': client.balance === 0})}>
